...
public class TwitterConsumer {
    public static void main(final String[] args) throws Exception {
        ...
        consumer.subscribe(Collections.singletonList("twitter-windowed-hashtag-counter"));
        ...
        while (true)
        {
            ...
            {
                System.out.println("-I- received message: " + record.key().key() + " (" + sdf.format(new Date(record.key().window().start())) + " - " + sdf.format(new Date(record.key().window().end())) + ")" + " / " + record.value());
            }
        }
    }
}
